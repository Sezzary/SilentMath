...
namespace Silent::Input
{
    ...
    const std::vector<EventId> GAMEPAD_EVENT_IDS =
    {
        ...
        EventId::StickLeftXNeg,
        EventId::StickLeftXPos,
        EventId::StickLeftYNeg,
        EventId::StickLeftYPos,
        EventId::StickRightXNeg,
        EventId::StickRightXPos,
        EventId::StickRightYNeg,
        EventId::StickRightYPos,
        EventId::TriggerLeft,
