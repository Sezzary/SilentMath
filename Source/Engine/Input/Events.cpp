...
namespace Silent::Input
{
    ...
    const std::vector<EventId> GAMEPAD_EVENT_IDS =
    {
        ...
        EventId::StickLeft,
        EventId::StickRight,
        EventId::ShoulderLeft,
        EventId::ShoulderRight,
        EventId::DpadUp,
        EventId::DpadDown,
        EventId::DpadLeft,
        EventId::DpadRight,
        EventId::PaddleRight0,
        EventId::PaddleLeft0,
        EventId::PaddleRight1,
        EventId::PaddelLeft1,
        ...
        EventId::StickLeftLeft,
        EventId::StickLeftRight,
        EventId::StickLeftUp,
        EventId::StickLeftDown,
        EventId::StickRightLeft,
        EventId::StickRightRight,
        EventId::StickRightUp,
        EventId::StickRightDown,
        EventId::TriggerLeft,
        EventId::TriggerRight
    };
    ...
    {   
        ...
        { EventId::ScrollUp,        { "Scroll Up" } },
        { EventId::ScrollDown,      { "Scroll Down" } },
        { EventId::ScrollLeft,      { "Scroll Left" } },
        { EventId::ScrollRight,     { "Scroll Right" } },
        ...
        { EventId::StickLeftLeft,   { "Left Stick Left" } },
        { EventId::StickLeftRight,  { "Left Stick Right" } },
        { EventId::StickLeftUp,     { "Left Stick Up" } },
        { EventId::StickLeftDown,   { "Left Stick Down" } },
        { EventId::StickRightLeft,  { "Right Stick Left" } },
        { EventId::StickRightRight, { "Right Stick Right" } },
        { EventId::StickRightUp,    { "Right Stick Up" } },
        { EventId::StickRightDown,  { "Right Stick Down" } },
