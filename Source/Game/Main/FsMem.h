...
{
    constexpr int FS_MEM_BLOCK_COUNT = 16;       /** Number of FS memory blocks that can be allocated. */
    constexpr int FS_MEM_BASE        = 0x1C0000; /** FS heap base (0x801C0000). */
    constexpr int FS_MEM_SIZE        = 0x20000;  /** FS heap size (128kb). */
