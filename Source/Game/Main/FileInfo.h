...
{
    constexpr int FS_BLOCK_SIZE    = 0x100; /** Units in which file size is measured in THE file table. */
    constexpr int FS_SECTOR_SIZE   = 0x800; /** Size of a CD sector (2048 bytes). */
    constexpr int FS_SECTOR_SHIFT  = 11;    /** For dividing by `FS_SECTOR_SIZE`. */
    constexpr int FS_NAME_CHAR_MAX = 8;     /** Maximum amount of characters in a file name (excluding extension and path). */
    constexpr int FS_INVALID_TYPE  = 0x0F;  /** Unspecified file type (or empty extension). */
