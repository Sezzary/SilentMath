...
{
    q19_12 MIN_IN_ROAD_DIST = Q12(1.0f); // `vcGetMinInRoadDist` in SH2, hardcoded to `Q12(1.0f)` in SH1.
    ...
    {
        constexpr q19_12 DEATH_TIME_MAX = Q12(10.0f);
    ...
    {
        constexpr q19_12 MOVE_DIST_MAX   = Q12(0.0125f);
        constexpr q19_12 ROT_X_ANGLE_MAX = Q12_ANGLE(20.0f);
        constexpr q19_12 ROT_Y_ANGLE_MAX = Q12_ANGLE(30.0f);
        constexpr q19_12 INTRPT_TIME_MIN = Q12(1.0f);
        constexpr q19_12 INTRPT_TIME_MAX = Q12(4.0f);
    ...
    void vcPreSetDataInVC_WORK(VC_WORK* w_p, VC_ROAD_DATA* vc_road_ary_list) // 0x80081B6C
    {
        ...
        vcWork.scr_half_ang_wx = (s16)(Math_Ratan2(g_GameWork.gsScreenWidth_588,  vcWork.geom_screen_dist) >> 1);
        vcWork.scr_half_ang_wy = (s16)(Math_Ratan2(g_GameWork.gsScreenHeight_58A, vcWork.geom_screen_dist) >> 1);
    ...
    {
        constexpr q19_12 ENEMY_DEATH_TIME_MAX = Q12(1.5f);
        constexpr q19_12 ENEMY_DIST_MAX       = Q12(15.0f);
        ...
        sc_p            = nullptr;
        all_min_sc_p    = nullptr;
        active_min_sc_p = nullptr;
        ...
        for (sc_p = &g_SysWork.npcs_1A0[0]; sc_p < &g_SysWork.npcs_1A0[ARRAY_SIZE(g_SysWork.npcs_1A0)]; sc_p++)
        {
                ...
                !(sc_p->flags_3E & CharaFlag_Unk5)) // `sc_p->battle(ShBattleInfo).status & (1 << 5)` in SH2.
            {
                ...
                Math_Ratan2(ofs_x, ofs_z); // @unused Result unused?
    ...
    void vcMakeNormalWatchTgtPos(VECTOR3* watch_tgt_pos, s16* watch_tgt_ang_z_p, VC_WORK* w_p,
                                 VC_CAM_MV_TYPE cam_mv_type, VC_AREA_SIZE_TYPE cur_rd_area_size) // 0x80082C58
    {
                                          ...
                                          VC_WORK* w_p, MATRIX* head_mat, s32 anim_status) // 0x80082DF8
    {
        ...
        vertical_angle = Math_Ratan2(-delta_y, Vc_VectorMagnitudeCalc(delta_x, 0, delta_z));
    ...
    void vcMakeIdealCamPosUseVC_ROAD_DATA(VECTOR3* ideal_pos, VC_WORK* w_p, VC_AREA_SIZE_TYPE cur_rd_area_size) // 0x80083F34
    {
        constexpr q19_12 ANGLE_DELTA_RANGE = Q12_ANGLE(12.0f);
    ...
    void vcCamTgtMvVecIsFlipedFromCharaFront(VECTOR3* tgt_mv_vec, VC_WORK* w_p, q19_12 max_tgt_mv_xz_len, VC_AREA_SIZE_TYPE cur_rd_area_size)
    {
        ...
        if (flip_dist > Q12(0.0f))
        {
            ...
            {
                ang_y          = Math_Ratan2(tgt_mv_vec->vx, tgt_mv_vec->vz);
