...
namespace Silent::Assets
{
    ...
    /** @brief Gets the aspect ratio of a TIM asset.
     *
     * @note Some TIMs are compressed and must be stretched horizontally.
     *
     * @param name TIM name.
     * @param res TIM resolution.
     * @return TIM aspect ratio.
     */
